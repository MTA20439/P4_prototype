...
class MainMenu(tk.Frame):
    def __init__(self, master):
        ...
        MainMenu.CB3 = tk.Checkbutton(self, text="Twinkle, Twinkle, Little Star",
                                      font=("Tofino Pro Personal Con Md", fs))
...
class PlayFrame(MainMenu):
    def __init__(self, master):
        ...
        if (self.var.get() == 1):
            ...
            self.nowPlayingLabel = tk.Label(self, text="Song 1", fg="white", background=myColor3, padx="0", pady="10",
            ...
            self.nowPlayingLabel = tk.Label(self, text="Song 2", fg="white", background=myColor3, padx="0", pady="10",
                                            font=("BELLABOO", 45)).grid(row=1, column=0)
            ...
            self.nowPlayingLabel = tk.Label(self, text="Twinkle, Twinkle, Little Star", fg="white", background=myColor3,
            ...
            self.nowPlayingLabel = tk.Label(self, text="Song 4", fg="white", background=myColor3, padx="0", pady="10",
                                            font=("BELLABOO", 45)).grid(row=1, column=0)
