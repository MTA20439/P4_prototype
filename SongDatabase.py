...
class SongDatabase:
    ...
    songOne = stringOne.split(" ") #Twinkle, Twinkle, Little Star
    #print(songOne)
    ...
    songTwo = stringTwo.split(" ") #Queen - I Want To Break Free (1 octave, simplified)
    ...
    songThree = stringThree.split(" ") #Oasis - Don't Look Back In Anger (2 octaves)
    ...
    songFour = stringFour.split(" ") #Super Mario Bros Theme (3 octaves!!)
